...
namespace PLUGIN_NAMESPACE
{
	...
	const IdString32 create_dragon_node_name("create_dragon");
	...
	const IdString32 kill_dragon_node_name("kill_dragon");
	...
	const IdString32 get_dragon_type_node_name("get_dragon_type");
	...
	const IdString32 get_dragon_age_node_name("get_dragon_age");
	...
	const IdString32 get_dragon_weight_node_name("get_dragon_weight");
	...
	const IdString32 feed_dragon_node_name("feed_dragon");
	...
	void init_dragon_flow_node(GetApiFunction get_engine_api)
	{
		...
		_flow_nodes_api->setup_trigger_function(create_dragon_node_name.id(), create_dragon_trigger);
		_flow_nodes_api->setup_trigger_function(kill_dragon_node_name.id(), kill_dragon_trigger);
		_flow_nodes_api->setup_trigger_function(get_dragon_type_node_name.id(), get_dragon_type_trigger);
		_flow_nodes_api->setup_trigger_function(get_dragon_age_node_name.id(), get_dragon_age_trigger);
		_flow_nodes_api->setup_trigger_function(get_dragon_weight_node_name.id(), get_dragon_weight_trigger);
		_flow_nodes_api->setup_trigger_function(feed_dragon_node_name.id(), feed_dragon_trigger);
	}

	void shutdown_dragon_flow_node()
	{
		_flow_nodes_api->unregister_flow_node(feed_dragon_node_name.id());
		_flow_nodes_api->unregister_flow_node(get_dragon_weight_node_name.id());
		_flow_nodes_api->unregister_flow_node(get_dragon_age_node_name.id());
		_flow_nodes_api->unregister_flow_node(get_dragon_type_node_name.id());
		_flow_nodes_api->unregister_flow_node(kill_dragon_node_name.id());
		_flow_nodes_api->unregister_flow_node(create_dragon_node_name.id());
